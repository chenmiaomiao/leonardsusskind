...
% \title{Particle Physics 1 Basic Concepts \thanks{Thanks to Edward R.~Tufte for his inspiration.}} % Title of the book
\title[Particle Physics 1]{%
  Particle Physics 1%
  \par\noindent
  \Huge{Basic Concepts}
}

\author[Leonard Susskind]{Leonard\ Susskind} % Author

\publisher{Notes taken by Chen Miao} % Publisher
