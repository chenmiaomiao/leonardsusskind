...
\]
Interchanging the labels or reversing the \(y\)-axis changes a sign convention, not the underlying construction. With Equation~\eqref{eq:l3-in-out-states}, the unique Hermitian matrix with these eigenvectors and eigenvalues is
\begin{equation}
\boxed{
\sigma_y=
\begin{pmatrix}
