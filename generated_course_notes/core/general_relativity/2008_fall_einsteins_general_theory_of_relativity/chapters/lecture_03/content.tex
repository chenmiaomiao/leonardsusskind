...
\begin{figure}[tbp]
  ...
  \caption{The displacement law and the general transformation of a
  contravariant vector. The Jacobian converts its components from the
  \(x\) coordinate system to the \(y\) coordinate system.}
