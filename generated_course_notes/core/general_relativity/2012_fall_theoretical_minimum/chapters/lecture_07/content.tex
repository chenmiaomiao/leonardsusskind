...
\lecturerresponse{The precise statement is
\(d\rho/dr=\sqrt{r/(r-1)}>1\) outside the unit horizon: a given coordinate
increment \(dr\) corresponds to a larger proper radial interval near the
horizon.  Saying that space is contracted or stretched depends on which
coordinate intervals are being compared.  The invariant statement is the
proper-distance relation itself.
