...
When their locations are not definite, exclusion asks whether the complete one-particle wavefunctions coincide. The Nevada--Connecticut superpositions make that distinction explicit.
...
\fill (0,-1) circle (1.5pt);
\node[right] at (0.82,0.82) {Fermi surface};
