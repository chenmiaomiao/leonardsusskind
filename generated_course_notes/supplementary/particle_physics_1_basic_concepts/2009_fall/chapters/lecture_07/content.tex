...
\end{equation}
Reversing the factors reverses the vector: \(\vec p\times\vec r=-\vec r\times\vec p\). The standard convention is \(\vec r\times\vec p\), with its direction fixed by the right-hand rule.\footnote{Lecture video frame \texttt{lecture\_07\_figure\_02.png}, 00:18:49.}
...
\begin{equation}
m=-m_{\max},-m_{\max}+1,\ldots,-1,0,1,\ldots,m_{\max}-1,m_{\max}.
\end{equation}
...
\end{equation}
within a fixed-spin multiplet.\footnote{Lecture video frame \texttt{lecture\_07\_figure\_03.png}, 01:01:08.}
