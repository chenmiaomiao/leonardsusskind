...
Feynman's path-integral formulation is the quantum-mechanical version of the principle of least action. Begin with an ordinary Newtonian particle. Its Lagrangian depends on the particle's coordinates and velocities,
\begin{equation}
...
=\mathcal{A}(x,t;x',t')\mathcal{A}(x,t;x',t')^*.
\end{equation}
...
\begin{equation}
\text{quadratic term}\ \longleftrightarrow\ \text{propagator},
\qquad
G_3\phi^3\ \longleftrightarrow\ \text{three-leg vertex}.
\end{equation}
