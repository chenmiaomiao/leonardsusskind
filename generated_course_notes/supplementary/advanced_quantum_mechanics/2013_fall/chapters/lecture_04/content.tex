...
\end{aligned}
\end{equation}
In this basis, \(\sigma_{z}\) is diagonal. Its eigenvalues are \(+1\) and
\(-1\).
...
The board calculation at \(00{:}49{:}35\) begins the entry-by-entry
multiplication. Completing the products gives
\begin{align}
\sigma_{z}\sigma_{x}
&=
\begin{pmatrix}
