...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[
    ...
    {\fontsize{30}{33}\selectfont\bfseries\color{black!88} Particle Physics 2:\\[0.15em]The Standard Model\\[0.85em]}
    {\large\color{black!72} Supplementary track, 2010 Winter }
  };
  \node[
    anchor=south west,
    align=left,
