...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[
    ...
    {\fontsize{30}{33}\selectfont\bfseries\color{black!88} Quantum Entanglement, Part 3\\[0.85em]}
    {\large\color{black!72} Supplementary course, 2006 Fall}
  };
  \node[
    anchor=south west,
    align=left,
...
The edition was prepared by \href{https://lazying.art}{LazyingArt LLC} using the open-source \href{https://github.com/lachlanchen/Video2Book}{Video2Book} toolkit. Machine transcripts remain available separately and may contain recognition errors. Editorial clarifications and nontrivial reconstructions are identified in footnotes.
\clearpage
\tableofcontents
\mainmatter
