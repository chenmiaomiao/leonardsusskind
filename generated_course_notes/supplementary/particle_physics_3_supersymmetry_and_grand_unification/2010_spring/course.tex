...
\hypersetup{
  pdftitle={Particle Physics 3: Supersymmetry and Grand Unification},
  pdfauthor={Leonard Susskind},
  pdfsubject={Independently edited companion notes for the 2010 Spring lecture course}
}
\begin{document}
\frontmatter
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[
    ...
    {\fontsize{30}{33}\selectfont\bfseries\color{black!88} Particle Physics 3:\\[0.15em]Supersymmetry and\\[0.15em]Grand Unification\\[0.85em]}
    {\large\color{black!72} Supplementary track, 2010 Spring }
  };
  \node[
    anchor=south west,
    align=left,
