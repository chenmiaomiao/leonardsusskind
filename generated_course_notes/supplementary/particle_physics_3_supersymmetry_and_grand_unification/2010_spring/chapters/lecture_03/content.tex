...
\end{tikzpicture}
\caption{The board at the scalar self-energy transition, followed by a conservative schematic redraw of the tadpole topology. The screenshot securely shows the loop, the relativistic and massless energy formulas, and a partial action; obscured coefficients and labels are not claimed as visible.}
\end{figure}
